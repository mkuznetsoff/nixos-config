{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-9f875b06-6983-48da-b302-acd367a4229e" = [ ];
      "ActivityManager"."switch-to-activity-bdff93ff-fa44-4e08-9337-0e691b97f9a1" = [ ];
      "ActivityManager"."switch-to-activity-dc47d0b0-077e-4a21-8d59-7a0bf106e044" = [ ];
